...
void onHelp(){
  ...
  mvprintw(12,5, "피드백을 받습니다. 예) 강물 -> ㄱ ㅏ ㅇ ㅁ ㅜ ㄹ 입력");
  mvprintw(
      14, 5,
      "2. 각 글자가 맞는 위치에 있는지 여부를 나타내는 색상이 표시됩니다");
  GREEN;
  mvprintw(15,5," *초록색 - 해당 글자가 올바른 위치에 있음 ");
  attron(YELLOW);
  mvprintw(16,5," *노란색 - 해당 글자가 단어에 포함되지만 위치가 틀렸음");
  mvprintw(17,5," *회색 - 해당 글자가 단어에 없음을 나타냅니다.");
  mvprintw(19, 5,
